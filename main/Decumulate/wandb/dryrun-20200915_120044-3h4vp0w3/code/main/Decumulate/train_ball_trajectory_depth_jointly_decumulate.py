...
def GravityLoss(output, trajectory_gt, mask, lengths):
  ...
  for i in range(trajectory_gt.shape[0]):
    ...
    gravity_constraint_penalize.append((trajectory_gt_yaxis_2nd_finite_difference - output_yaxis_2nd_finite_difference)**2)

  print(gravity_constraint_penalize)
  print(pt.tensor(gravity_constraint_penalize).shape)
  return pt.mean(pt.tensor(gravity_constraint_penalize))
