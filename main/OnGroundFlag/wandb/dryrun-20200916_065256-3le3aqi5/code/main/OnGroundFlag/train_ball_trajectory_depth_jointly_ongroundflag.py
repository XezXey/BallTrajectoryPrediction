...
def train(output_trajectory_train, output_trajectory_train_mask, output_trajectory_train_lengths, output_trajectory_train_startpos, output_trajectory_train_xyz, input_trajectory_train, input_trajectory_train_mask, input_trajectory_train_lengths, input_trajectory_train_startpos, model_flag, model_depth, output_trajectory_val, output_trajectory_val_mask, output_trajectory_val_lengths, output_trajectory_val_startpos, output_trajectory_val_xyz, input_trajectory_val, input_trajectory_val_mask, input_trajectory_val_lengths, input_trajectory_val_startpos, projection_matrix, camera_to_world_matrix, epoch, n_epochs, vis_signal, optimizer, width, height, visualize_trajectory_flag=True, visualization_path='./visualize_html/'):
  ...
  train_eot_loss = FlagLoss(output_flag=output_train_flag, flag_gt=input_trajectory_train_gt[..., -1], mask=input_trajectory_train_mask[..., -1], lengths=input_trajectory_train_lengths, flag_startpos=input_trajectory_train_startpos[..., -1], mode='Train')
  train_onground_loss = FlagLoss(output_flag=output_train_flag, flag_gt=input_trajectory_train_gt[..., -2], mask=input_trajectory_train_mask[..., -2], lengths=input_trajectory_train_lengths, flag_startpos=input_trajectory_train_startpos[..., -2], mode='Train')
  ...
  val_eot_loss = FlagLoss(output_flag=output_val_flag, flag_gt=input_trajectory_val_gt[..., -1], mask=input_trajectory_val_mask[..., -1], lengths=input_trajectory_val_lengths, flag_startpos=input_trajectory_val_startpos[..., -1], mode='Validation')
  val_onground_loss = FlagLoss(output_flag=output_val_flag, flag_gt=input_trajectory_val_gt[..., -2], mask=input_trajectory_val_mask[..., -2], lengths=input_trajectory_val_lengths, flag_startpos=input_trajectory_val_startpos[..., -2], mode='Validation')
