...
def train(input_train_dict, gt_train_dict, input_val_dict, gt_val_dict, model_list, epoch, vis_signal, optimizer, cam_params_dict, vis_flag=True, visualization_path='./visualize_html/'):
  ...
  return train_loss.item(), val_loss.item(), model_list
...
if __name__ == '__main__':
  ...
  for epoch in range(start_epoch, n_epochs+1):
    ...
    for batch_idx, batch_train in enumerate(trajectory_train_dataloader):
      print('\n===> [Minibatch {}/{}].........'.format(batch_idx+1, len(trajectory_train_dataloader)), end='')
      ...
      train_loss, val_loss, model_list = train(input_train_dict=input_train_dict, gt_train_dict=gt_train_dict, input_val_dict=input_val_dict, gt_val_dict=gt_val_dict,
