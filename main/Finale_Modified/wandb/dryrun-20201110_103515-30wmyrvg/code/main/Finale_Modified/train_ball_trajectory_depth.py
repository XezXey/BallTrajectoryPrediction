...
def train(input_train_dict, gt_train_dict, input_val_dict, gt_val_dict, model_list, epoch, vis_signal, optimizer, cam_params_dict, vis_flag=True, visualization_path='./visualize_html/'):
  ...
  train_loss_dict, train_loss = utils_model.calculate_loss(pred_xyz=pred_xyz_train, gt_dict=gt_train_dict, cam_params_dict=cam_params_dict) # Calculate the loss
  ...
  optimizer.zero_grad() # Clear existing gradients from previous epoch
  val_loss_dict, val_loss = utils_model.calculate_loss(pred_xyz=pred_xyz_val, gt_dict=gt_val_dict, cam_params_dict=cam_params_dict) # Calculate the loss
