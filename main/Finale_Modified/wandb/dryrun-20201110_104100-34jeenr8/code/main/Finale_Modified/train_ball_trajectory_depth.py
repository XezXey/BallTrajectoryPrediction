...
def train(input_train_dict, gt_train_dict, input_val_dict, gt_val_dict, model_list, epoch, vis_signal, optimizer, cam_params_dict, vis_flag=True, visualization_path='./visualize_html/'):
  ...
  train_loss_dict, train_loss = utils_model.calculate_loss(pred_xyz=pred_xyz, gt_dict=gt_train_dict, cam_params_dict=cam_params_dict, pred_list=pred_list_train) # Calculate the loss
