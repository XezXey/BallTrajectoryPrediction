...
if __name__ == '__main__':
  ...
  for epoch in range(start_epoch, n_epochs+1):
    ...
    gt_trajectory_val = batch_val['gt'][0].to(device)
    gt_trajectory_val_lengths = batch_val['gt'][1].to(device)
    gt_trajectory_val_mask = batch_val['gt'][2].to(device)
    gt_trajectory_val_startpos = batch_val['gt'][3].to(device)
    gt_trajectory_val_xyz = batch_val['gt'][4].to(device)
