...
def collate_fn_padd(batch):
    ...
    print(pt.Tensor(batch[0][..., features_cols]).shape)
    ...
    # print(pt.cumsum(gt_xyz[..., [x, y, z]], dim=1).shape, gt_xyz[..., features_cols].shape)
    # gt_xyz = pt.cat((pt.cumsum(gt_xyz[..., [x, y, z]], dim=1), gt_xyz[..., features_cols]), dim=2)
