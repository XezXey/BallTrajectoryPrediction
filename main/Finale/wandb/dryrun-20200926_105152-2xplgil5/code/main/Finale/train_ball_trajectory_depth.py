...
from utils.initialize_folder import initialize_folder
# Models
...
if __name__ == '__main__':
  ...
  # Model definition
  min_val_loss = 2e10
  model_flag, model_depth = get_model(model_arch=args.model_arch)
  ...
  lr_scheduler = pt.optim.lr_scheduler.ExponentialLR(optimizer=optimizer, gamma=args.decay)
  start_epoch = 1
