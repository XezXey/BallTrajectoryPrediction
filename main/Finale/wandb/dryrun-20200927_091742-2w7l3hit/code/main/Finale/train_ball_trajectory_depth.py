...
if __name__ == '__main__':
  ...
  for epoch in range(start_epoch, n_epochs+1):
    ...
    for batch_idx, batch_train in enumerate(trajectory_train_dataloader):
      ...
      train_loss, val_loss, model_flag, model_depth = train(train_input=train_input, train_gt=train_gt, val_input=val_input, val_gt=val_gt, model_flag=model_flag, model_depth=model_depth,
                                                            vis_flag=args.vis_flag, optimizer=optimizer, epoch=epoch, vis_signal=vis_signal,
