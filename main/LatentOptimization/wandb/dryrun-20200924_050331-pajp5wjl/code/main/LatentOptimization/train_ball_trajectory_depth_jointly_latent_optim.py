...
def add_noise(input_trajectory, startpos, lengths):
  ...
  print(startpos.shape, input_trajectory.shape)
...
def train(output_trajectory_train, output_trajectory_train_mask, output_trajectory_train_lengths, output_trajectory_train_startpos, output_trajectory_train_xyz, input_trajectory_train, input_trajectory_train_mask, input_trajectory_train_lengths, input_trajectory_train_startpos, model_eot, model_depth, output_trajectory_val, output_trajectory_val_mask, output_trajectory_val_lengths, output_trajectory_val_startpos, output_trajectory_val_xyz, input_trajectory_val, input_trajectory_val_mask, input_trajectory_val_lengths, input_trajectory_val_startpos, projection_matrix, camera_to_world_matrix, epoch, n_epochs, vis_signal, optimizer, width, height, visualize_trajectory_flag=True, visualization_path='./visualize_html/'):
  ...
  if args.noise:
    input_trajectory_train = add_noise(input_trajectory=input_trajectory_train[..., [0, 1]], startpos=input_trajectory_train_startpos, lengths=input_trajectory_train_lengths)
    input_trajectory_train_eot = input_trajectory_train[..., [0, 1]].clone()
    input_trajectory_val = add_noise(input_trajectory=input_trajectory_val[..., [0, 1]], startpos=input_trajectory_val_startpos, lengths=input_trajectory_val_lengths)
  ...
  input_trajectory_train = pt.cat((input_trajectory_train[..., [0, 1, 3]], output_train_eot), dim=2)
  ...
  if args.decumulate and epoch > args.start_decumulate:
    ...
    output_train_depth_cumsum, input_trajectory_train_uv_cumsum = cumsum_trajectory(depth=output_train_depth, uv=input_trajectory_train_gt[..., :-1], trajectory_startpos=input_trajectory_train_startpos[..., [0, 1, 2]])
  ...
  train_eot_loss = EndOfTrajectoryLoss(output_eot=output_train_eot, eot_gt=input_trajectory_train_gt[..., [2]], mask=input_trajectory_train_mask[..., [0, 1, 2]], lengths=input_trajectory_train_lengths, eot_startpos=input_trajectory_train_startpos[..., [3]], flag='Train')
