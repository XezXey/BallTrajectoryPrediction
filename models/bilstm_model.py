...
class BiLSTM(pt.nn.Module):
  def __init__(self, input_size, output_size, hidden_dim, n_layers):
    ...
    self.lstm1 = pt.nn.LSTM(input_size=input_size, hidden_size=self.hidden_dim, num_layers=n_layers, batch_first=True, bidirectional=True, dropout=0.9)
    self.lstm2 = pt.nn.LSTM(input_size=self.hidden_dim*2, hidden_size=self.hidden_dim, num_layers=n_layers, batch_first=True, bidirectional=True, dropout=0.9)
    self.lstm3 = pt.nn.LSTM(input_size=self.hidden_dim*2, hidden_size=self.hidden_dim, num_layers=n_layers, batch_first=True, bidirectional=True, dropout=0.9)
    # FC
    self.fc1 = pt.nn.Linear(self.hidden_dim*2, 32, bias=True)
