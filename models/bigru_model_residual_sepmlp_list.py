...
class BiGRUResidualSepMLPList(pt.nn.Module):
  def __init__(self, input_size, output_size):
    super(BiGRUResidualSepMLPList, self).__init__()
  ...
  def forward(self, x, hidden, cell_state, lengths):
    ...
    out_uv = self.fc_blocks_uv(out_unpacked) #* focal_length
