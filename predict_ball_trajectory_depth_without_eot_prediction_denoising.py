...
if __name__ == '__main__':
  ...
  for batch_idx, batch_test in enumerate(trajectory_test_dataloader):
    ...
    accepted_3axis_maxdist, accepted_3axis_loss, accepted_trajectory_loss = predict(output_trajectory_test=output_trajectory_test, output_trajectory_test_mask=output_trajectory_test_mask,
